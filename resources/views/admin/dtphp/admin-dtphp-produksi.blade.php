...
<div class="flex flex-col gap-4 my-4 w-full">
    <div class="flex flex-wrap gap-6 max-md:gap-4 items-end justify-between w-full tabs">
        ...
        <!-- Filter Component -->
        <div class="relative flex justify-end w-full sm:w-auto">
            <x-filter />
...
<main class="flex-1 p-6 max-md:p-4 bg-gray-10 border-gray-20 border-[3px] rounded-[20px]">
    <div class="w-full flex items-center gap-2 mb-4">
        ...
        <h2 class="text-2xl font-extrabold max-md:text-lg">HEKTAR LUAS PANEN</h2>                     
    </div>
    ...
    <div class="w-full bg-white rounded shadow-md flex flex-col items-center justify-center p-8 max-md:p-4  relative border bg-gray-10 border-gray-20">
        <div class="flex items-center flex-col mb-3 font-bold text-green-910 text-center max-md:text-sm">
