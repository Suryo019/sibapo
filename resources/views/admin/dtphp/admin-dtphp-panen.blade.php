    ...
    <main class="flex-1 p-6">
        ...
        <div class="flex gap-4 mb-4">
            <a href="{{ route('dtphp.produksi') }}">
                <button class="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-800 {{ request()->routeIs('dtphp.produksi') ? 'font-bold' : '' }}">
                    Volume Produksi
                </button>
            </a>
            <a href="{{ route('dtphp.panen') }}">
                <button class="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-800 {{ request()->routeIs('dtphp.panen') ? 'font-bold' : '' }}">
                    Luas Panen
                </button>
            </a>
        </div>
