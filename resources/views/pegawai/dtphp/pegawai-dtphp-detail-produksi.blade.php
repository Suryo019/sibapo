<x-pegawai-layout title="Detail Data Produksi">
    ...
    <main class="flex-1 p-6 max-md:p-4 bg-gray-10 border-gray-20 border-[3px] rounded-[20px]">
        ...
        <h3 class="text-2xl font-semibold text-center max-md:text-base">
            DATA VOLUME PRODUKSI TAHUN {{ isset($_GET['periode']) ? date('Y', strtotime($_GET['periode'] . '-01')) : date('Y') }} (Ton)
        </h3>
        </div>
        ...
        <a href="{{ route('pegawai.dtphp.detail.produksi') }}">
            <button class="text-pink-500 rounded-t-xl bg-white px-4 py-3 shadow-md text-sm border bg-gray-10 border-gray-20 {{ request()->routeIs('pegawai.dtphp.detail.produksi') ? 'font-bold' : '' }} max-md:text-xs max-md:px-3 max-md:py-2">Volume Produksi</button>
        </a>
        <a href="{{ route('pegawai.dtphp.detail.panen') }}">
            <button class="text-gray-400 rounded-t-xl bg-gray-100 px-4 py-3 shadow-md text-sm border bg-gray-10 border-gray-20 {{ request()->routeIs('pegawai.dtphp.detail.panen') ? 'font-bold' : '' }} max-md:text-xs max-md:px-3 max-md:py-2">Luas Panen</button>
        </a>
        </div>
