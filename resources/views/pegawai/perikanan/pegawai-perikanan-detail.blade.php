            ...
            <x-filter-modal>
                <form action="" method="get">
                    ...
                    <div class="w-full flex justify-end gap-3 mt-10">
                        <a href="{{ route('pegawai.perikanan.detail') }}" class="bg-yellow-550 text-white rounded-lg w-20 p-1 text-center">Reset</a>
