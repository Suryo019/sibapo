    ...
    <div class="w-full flex flex-col md:flex-row justify-between gap-4 mb-4">
        ...
        <div class="flex justify-end w-full md:w-auto">
            <div class="relative">
                ...
                <!-- Modal Background -->
                <div id="filterModal" class="mt-10 absolute hidden items-center justify-center z-50 w-full max-w-sm">
                    <!-- Modal Content -->
                    <div class="bg-white w-full rounded-lg shadow-black-custom p-6 relative">
                        <!-- Close Button -->
