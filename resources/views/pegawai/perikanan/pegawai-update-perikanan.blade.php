    ...
    <main class="flex-1 p-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md mt-6">
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        class="w-full border border-gray-300 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500"
                ...
                <!-- Tanggal Input -->
                <div class="mb-4">
                    <label for="tanggal_input" class="block text-sm font-medium text-pink-500 mb-1">Terakhir Diubah</label>
                    <input
                        type="date"
                        name="tanggal_input"
                        id="tanggal_input"
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mt-6">
                ...
                <button type="button" id="submitBtn" class="w-full sm:w-auto bg-yellow-550 text-white px-6 py-2 rounded-xl hover:bg-yellow-500 transition duration-300">
                    Simpan
                </button>
            </div>
        </div>
