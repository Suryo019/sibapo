...
<x-pegawai-layout title="Data Ikan">
    ...
    <main class="flex-1 p-6 max-md:p-4 bg-gray-10 border-gray-20 border-[3px] rounded-[20px]">
        ...
        <div class="w-full flex items-center gap-2 mb-4 flex-wrap">
            <a href="{{ route('pegawai.perikanan.dashboard') }}" class="text-dark flex-shrink-0">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-2 py-2 text-center">
                                <div class="flex justify-center gap-1">
                                    <a href="{{ route('pegawai.jenis-ikan.edit', $item->id) }}">
