...
<script>
    ...
    function markAsCompleted(notificationId) {
        ...
        fetch(`/pegawai/disperindag/notifications/${notificationId}/complete`, {
            method: 'POST',
            headers: {
    ...
    function markAsIncomplete(notificationId) {
        ...
        fetch(`/pegawai/disperindag/notifications/${notificationId}/incomplete`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    function deleteNotification(notificationId) {
        ...
        fetch(`/pegawai/disperindag/notifications/${notificationId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
