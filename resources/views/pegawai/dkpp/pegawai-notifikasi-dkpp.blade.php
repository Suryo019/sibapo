...
<script>
    ...
    function markAsCompleted(notificationId) {
        ...
        fetch(`/pegawai/dkpp/notifications/${notificationId}/complete`, {
            method: 'POST',
            headers: {
    ...
    function markAsIncomplete(notificationId) {
        ...
        fetch(`/pegawai/dkpp/notifications/${notificationId}/incomplete`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
    ...
    function deleteNotification(notificationId) {
        ...
        fetch(`/pegawai/dkpp/notifications/${notificationId}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
