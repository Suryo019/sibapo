    ...
    <div class="w-full h-96 flex flex-col justify-center items-center text-pink-650 ">
        ...
        <form action="{{ route('tamu.pasar') }}">
            ...
            <div class="w-96 bg-yellow-450 flex justify-between items-center pl-6 pr-3 py-1 rounded-full">
                ...
                <input type="text" placeholder="Cari Pasar" id="pasar" name="pasar" class="border-none outline-none focus:bg-transparent text-pink-650 placeholder-pink-650 bg-transparent flex-1">
