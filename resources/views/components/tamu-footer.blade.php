<footer class="text-white">
  ...
  <!-- Bagian Atas pink -->
  <div class="bg-pink-600 py-12 px-6 relative overflow-hidden">
    <div class="max-w-6xl mx-auto flex flex-col items-start text-left relative z-10">
      <h2 class="text-2xl md:text-3xl font-semibold">Butuh Bantuan?</h2>
      <p class="text-sm mt-1 mb-4">Tanyakan apapun dan kami siap membantu Anda!</p>
      <a href="#" class="bg-pink-600 text-white font-medium px-6 py-2 rounded-full border border-white ">
        Hubungi Kami Sekarang
      </a>
    </div>
    <img src="{{ asset('img/kembang-sidebar-2.png') }}" 
         alt=""
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-40">
      <div>
        <div class="flex items-center gap-2 mb-3">
          <img src="{{ asset('img/logo.png') }}" alt="Logo SIBAPO" class="h-30">
        </div>
