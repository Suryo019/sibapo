...
<div class="max-md:mb-2 max-md:rounded-lg max-md:bg-pink-650">
  ...
  <ul class="dropdown-content-komoditas {{ request()->is($routeKelolaKomoditas . '*') ? 'block' : 'hidden' }}">
    @php
...
<div class="max-md:mb-2 max-md:rounded-lg max-md:bg-pink-650">
  ...
  <ul class="dropdown-content-kelola-data {{ $isMenuActive ? 'block' : 'hidden' }}">
...
<script>
$(document).ready((function(){$("#kelola_data_{{ $dinas }}").on("click",(function(){const o=$(this).next("ul.dropdown-content-kelola-data"),t=$(this).find(".caret-icon");o.slideToggle(200),t.toggleClass("bi-caret-down-fill bi-caret-up-fill")})),$("#kelola_komoditas_{{ $dinas }}").on("click",(function(){const o=$(this).next("ul.dropdown-content-komoditas"),t=$(this).find(".caret-icon");o.slideToggle(200),t.toggleClass("bi-caret-down-fill bi-caret-up-fill")}))}));
</script>