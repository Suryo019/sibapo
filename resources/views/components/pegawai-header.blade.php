...
<header {{ $attributes }}>
    ...
    <div class="flex items-center gap-6">
        ...
        <!-- Profil -->
        <div class="flex items-center gap-3 cursor-pointer" id="profile-toggler">
            <img src="{{ $imagePath }}" alt="Profile" class="w-10 h-10 rounded-full bg-gray-300 scale-95 md:scale-100">
            <span class="text-sm hidden md:block">
                Hi, <b class="text-yellow-500">{{ Auth::user()->username }}</b>!
            </span>
        </div>
    </div>
</header>
